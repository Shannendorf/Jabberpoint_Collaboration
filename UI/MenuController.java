...
public class MenuController extends MenuBar {
	...
	public MenuController(Frame frame, JabberPointFacade jabberPointFacade) {
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent actionEvent) {
				jabberPointFacade.clearPresentation();
				try {
                    jabberPointFacade.loadFile(TESTFILE);
        ...
        menuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
                jabberPointFacade.addEmptySlide();
                parent.repaint();
            }
        } );
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					jabberPointFacade.saveFile(SAVEFILE);
				} catch (IOException exc) {
					JOptionPane.showMessageDialog(parent, IOEX + exc, 
		...
		menuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent actionEvent) {
                ...
                jabberPointFacade.setSlideNumber(pageNumber - 1);
			}
		});
		add(viewMenu);
